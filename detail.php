                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="barangkeluar" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambildatapeminjaman = mysqli_query($conn,"select * from peminjaman where idbarang='$idbarang'");
                                            $i = 1;

                                            while ($fetch=mysqli_fetch_array($ambildatapeminjaman)) {
                                                $tanggal = $fetch['tglpinjam'];
                                                $penerima = $fetch['peminjam'];
                                                $quantity = $fetch['qty'];
                                                $status = $fetch['status'];
